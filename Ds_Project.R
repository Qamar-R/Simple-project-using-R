...
promotion <- read.csv("G:/FCDS/semester 3/Intro To Data Science/Project/DataSet/train.csv",na.strings = c("","NA"))
...
#---------------------------------------------------------------------
View(cleaned_data_withoutOutliers) #show cleaned data
################################################################################
